...
class StableRadarLineDetector:
    def __init__(self):
        ...
        self.hough_threshold = 25      # Lowered for better detection of short lines
        self.min_line_length = 50      # Shorter for flanges
        self.max_line_gap = 50         # Larger gap tolerance
        
        # Separate parameters for short lines (flanges)
        self.flange_hough_threshold = 25    # Even lower for flanges
        self.flange_min_line_length = 20    # Very short lines
        self.flange_max_line_gap = 18        # Smaller gaps for flanges
        
        # Edge detection parameters
        self.canny_low = 30            # Lower thresholds for better edge detection
        self.canny_high = 120
        ...
        self.max_line_age = 10         # max frames without detection
        
        # Advanced filtering parameters
        self.min_line_length_meters = 0.3  # Shorter for flanges
        self.min_line_deg= 90
        self.min_flange_length_meters = 0.13 # Very short flanges
